...
function ckstyle() { //定义总的风格
    var ck = {
		...
		*/
		...
		以下是播放器自带的二个插件
		*/
        control_rel: 'related.swf,/statics/ckplayer/related.xml,0',
        /*
		视频结束显示精彩视频的插件
		...
		*/
		...
		/*
			跳过广告和播放结束时调用的js函数
		*/
		myweb: escape('f68b9e926e60a5caaf15d7bf8eef0670,cditv player,http://www.cditv.cn,v1.0'),
        /*
		------------------------------------------------------------------------------------------------------------------
		...
		*/
        cpt_share: '/statics/ckplayer/share.xml',
        /*
		分享插件调用的配置文件地址
		调用插件开始
		*/
